...
Page({
  ...
  onShareAppMessage: function (res) {
    if (res.from === 'button') { }
    return {
      title: this.data.cakedata.cakename,
      path: '/pages/CakeDetail/CakeDetail?cakeid=' + this.data.cakeId,
      imageUrl: this.data.cakedata.mainPic[0],
